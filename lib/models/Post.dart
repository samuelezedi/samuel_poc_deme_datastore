...
class Post extends Model {
  ...
  const Post._internal({required this.id, title, ssn, blog, comments, createdAt, updatedAt}): _title = title, _ssn = ssn, _blog = blog, _comments = comments, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Post({String? id, String? title, String? ssn, Blog? blog, List<Comment>? comments}) {
  ...
  Post copyWith({String? title, String? ssn, Blog? blog, List<Comment>? comments}) {
    return Post._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'ssn': _ssn, 'blog': _blog?.toJson(), 'comments': _comments?.map((Comment? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'title': _title, 'ssn': _ssn, 'blog': _blog, 'comments': _comments, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
  ...
  static final QueryField SSN = QueryField(fieldName: "ssn");
